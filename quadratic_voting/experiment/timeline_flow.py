...
const aggregateStats=c=>c.aggregateVotes==null?'Credits & votes unavailable':`Credits: ${c.aggregateCredits??'\\u2014'} \\u00b7 Votes: ${c.aggregateVotes}`;
